    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.ImageField(default=None, null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DefaultBuff', models.JSONField(default=None, null=True)),
                ('Rare', models.IntegerField(default=0)),
                ('pack', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Packs.packsmodel')),
            ],
        ),
    ]
